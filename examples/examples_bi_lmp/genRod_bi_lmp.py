...
if __name__ == '__main__':	
	...
	nanorod.readDATA(f"AuRod.data",atom_style="id type x y z", guessing_bond=True, lattice_const=4.08)
	...
	# save gro and itp
	peo_g_np.toDATA(f"peo_g_rod_gft-R-{str(radius)}-sigma-{str(gft)}-{graft_type}_bi.data")
