...
if __name__ == '__main__':	
	...
	radius = 20.0
	lattice.gen_particle(radius,outFile=f"AuNP-R20.data")
	nanoparticle = Crystal("nanoparticle", 'Au', radius)
	nanoparticle.readDATA(f"AuNP-R20.data",atom_style="id type x y z", guessing_bond=True, lattice_const=4.08)
	...
	# save gro and itp
	peo_g_np.toDATA(f"peo_g_np_gft-R-{str(radius)}-sigma-{str(gft)}-{graft_type}_bi.data")
