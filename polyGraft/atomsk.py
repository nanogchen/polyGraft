...
class Atomsk:
	...
	def gen_particle(self, radius, outFile='particle.pdb'):
	...
	def gen_pore(self, radius, depth, outFile='pore.pdb'):
		...
		Nxy = int(2*radius/self.lattice_const_)+4
		Nz = int(depth/self.lattice_const_)
...
# if __name__ == '__main__':
	...
	# # create a slab
	# lattice.gen_slab(length=50.0, width=50.0, depth=10.0, outFile="Auslab.pdb")

	# # create a particle
	# lattice.gen_particle(radius=20.0, outFile="AuNP.pdb")

	# # create a rod
	# lattice.gen_rod(radius=10.0, depth=50.0, outFile="Aurod.pdb")

	# # create a pore
	# lattice.gen_pore(radius=40.0, depth=50.0, outFile="Aupore.pdb")
